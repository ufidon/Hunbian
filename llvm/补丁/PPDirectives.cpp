...
bool Preprocessor::CheckMacroName(Token &MacroNameTok, MacroUse isDefineUndef,
  ...
  (II->getPPKeywordID() == tok::pp_defined || II->getPPKeywordID() == tok::pp_定了)) {
...
void Preprocessor::HandleSkippedDirectiveWhileUsingPCH(Token &Result,
  ...
  if (const IdentifierInfo *II = Result.getIdentifierInfo()) {
    if (II->getPPKeywordID() == tok::pp_define || II->getPPKeywordID() == tok::pp_定) {
      return HandleDefineDirective(Result,
                                   /*ImmediatelyAfterHeaderGuard=*/false);
    }
    if (SkippingUntilPCHThroughHeader &&
        (II->getPPKeywordID() == tok::pp_include || II->getPPKeywordID() == tok::pp_包含)) {
      return HandleIncludeDirective(HashLoc, Result);
    }
    if (SkippingUntilPragmaHdrStop && 
    (II->getPPKeywordID() == tok::pp_pragma || II->getPPKeywordID() == tok::pp_译示)) {
      Lex(Result);
...
Preprocessor::ImportAction Preprocessor::HandleHeaderIncludeOrImport(
  ...
  bool EnterOnce =
      ...
      IncludeTok.getIdentifierInfo()->getPPKeywordID() == tok::pp_入港;
  ...
  case Import: {
    ...
    if (IncludeTok.getIdentifierInfo()->getPPKeywordID() == tok::pp___include_macros ||
    IncludeTok.getIdentifierInfo()->getPPKeywordID() == tok::pp__含宏)
      return {ImportAction::None};
